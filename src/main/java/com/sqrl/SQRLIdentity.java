...
public class SQRLIdentity {
	 ...
	 * 
	 * This is the first 128-bits of SHA256(scrypt_result) and is
	 * used to verify the password was entered correctly.
	 */
	...
	public SQRLIdentity(String identityName, byte[] masterIdentityKey,
			byte[] passwordVerify, byte[] passwordSalt) {
	...
	public String toString() {
		return "SQRLIdentity [identityName=" + identityName
				+ ", masterIdentityKey=" + Base64.encode(masterIdentityKey)
				+ ", passwordVerify=" + Base64.encode(passwordVerify)
